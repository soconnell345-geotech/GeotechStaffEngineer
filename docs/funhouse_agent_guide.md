...
- **Full eval coverage (96 questions as of v5.4) needs the optional-dependency extras:** install
...
# 2. The geotech eval suite (96 questions as of v5.4) through the deep agent.
