...
- Eval suite (97 questions as of v5.4): `from funhouse_agent.deep.eval_harness import run_suite;
...
- `funhouse_agent/deep/eval_harness.py` — `run_suite` (97-question eval) + scorers.
