    ...
    def ask(self, question: str) -> AgentResult:
        ...
        for rounds in range(1, self._max_rounds + 1):
            ...
            if parsed.tool_call is None:
                # Check if this is an incomplete thought rather than a real
                # answer.  On follow-up questions the LLM sometimes emits
                # only a planning step ("Thought: I need to...") without a
                # <tool_call>.  Feed it back with a nudge so the model can
                # continue.
