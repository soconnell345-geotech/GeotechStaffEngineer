...
| V-085/086 | slope_stability grouted tiebacks (Duncan & Wright 2005 Fig 6.34/7.28 / Slide2 #85/#86) — v5.4 F2 attempt | — | #85 Bishop 1.531 active / 1.324 passive (ref 1.51/1.32); #86 Bishop 1.629 (ref 1.61) | — | **DEFERRED (search robustness)** | Both geometries recovered (labeled): #85 saturated clay c=350 psf/φ=0, single 9,000 lb/ft support at mid-height on a steep 0.5:1 20-ft face; #86 c'=0/φ=37 fill on rigid rock with five 800 lb/ft tiebacks. Both BLOCKED by circular-search robustness on these steep / thin-layer / c'=0 sections: the centre-grid + entry-exit searches converge to spurious degenerate circles (centres outside the domain or dipping below the rigid base; #86 c'=0 toe circles at 0.55, below the 0.94 infinite-slope value) that the supports do not engage, so a faithful with-support global FOS is not cleanly reproduced. Not tuned/pinned — flagged as a search-robustness follow-up (a physical-centre / below-base rejection guard, akin to the E1 drawdown-search gate). The Anchor reinforcement mechanic itself is exercised at V-043 (geosynthetic force). |
