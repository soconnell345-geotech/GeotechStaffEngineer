...
| V-036 | slope_stability `infinite_slope_fos` (Duncan-Wright / Slide2 #81) | FOS = tan(30)/0.5 = 1.155 | Bishop/Spencer/GLE 1.155; referee 1.15 | 0.0% | **PASS** | Cohesionless 2:1 embankment (c'=0, φ'=30). Exact. The new method also covers c-φ, seepage-parallel and ru cases (unit-tested in slope_stability/tests/test_b2_round1.py). |
