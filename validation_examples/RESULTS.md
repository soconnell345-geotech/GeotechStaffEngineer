...
| V-027 | slope_stability 3-layer + seismic 0.15g (ACADS 1(d) / Slide2 #4) | static Bishop 1.02-1.23 (toe-soil ambiguous); seismic Bishop 0.78-0.91 | seismic Bishop 1.016, Spencer 0.991, GLE 0.989, Janbu-c 0.965; referee 1.00 | seismic −10 to −23% | **N/A (geometry-precision)** | Reconstructed 3-layer geometry (labeled surface + soils, but MODERATE-confidence layer boundaries). Even the strongest defensible soil config (all Soil#2 below Soil#1) reaches only seismic 0.913 vs 1.016 — the FOS is highly sensitive to the exact material boundaries, which the figure does not label-resolve. The pseudo-static seismic ENGINE is validated to +0.5% by the clean-geometry Loukidis #62 (V-033), so this is a geometry-reconstruction limit, NOT a kh bug. No passing test. |
