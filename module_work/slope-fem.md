...
**Owned modules:** slope_stability, fem2d, fdm2d
...
- Standards/theory: DM7.1 (slopes); Duncan & Wright (limit equilibrium); SRM/FEM + FLAC-style FDM theory in module DESIGN.md.
...
- ☐ Extend `allowed_values` to fem2d, fdm2d adapters.
