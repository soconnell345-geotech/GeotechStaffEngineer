...
**Owned modules:** bearing_capacity, settlement, retaining_walls, ground_improvement, downdrag
...
- Standards: DM7.1/7.2 (shallow foundations, settlement); GEC-11 (retaining + MSE walls);
  GEC-13 (ground improvement); UFC 3-220-20 (downdrag) — refs in `geotech-references/`.
...
- ☐ Extend `allowed_values` to settlement, retaining_walls, ground_improvement, downdrag adapters.
