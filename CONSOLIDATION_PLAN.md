...
| 7 | Reliability + sensitivity | **BUILT — native `reliability/` module** (176 tests): RandomVariable model (4 dists, truncation, correlation), FOSM/Duncan-2000, Rosenblueth PEM, Monte Carlo (LHS, Nataf-lite), native FORM (HL-RF/Rackwitz-Fiessler, pystra-cross-checked to 4 decimals), published COV knowledge base (Duncan 2000 Table 1 verified, ISSMGE-TC304 2021, P&K transformation), Vanmarcke spatial averaging, bearing/pile wrappers + slope delegate, funhouse adapter. `pystra` kept for SORM; `salib` kept for sensitivity; `gstools` pointer for random fields. See reliability/VALIDATION.md. | built in-house on branch `reliability` | — | DONE 2026-06-11 |
...
- **Backlog:** (none — #7 DONE 2026-06-11: native reliability/ module built, see reliability/UPGRADE_PLAN.md + VALIDATION.md. #9 foundry staleness: DONE 2026-06-10, see module_work/foundry_staleness_report.md.)
