...
METHOD_INFO = {
    "analyze_hvsr": {
        ...
        "parameters": {
            ...
            "smoothing_operator": {"type": "str", "required": False, "default": "konno_and_ohmachi", "allowed_values": ["konno_and_ohmachi", "parzen", "savitzky_and_golay"], "description": "Spectral smoothing operator."},
            ...
            "horizontal_method": {"type": "str", "required": False, "default": "geometric_mean", "allowed_values": ["geometric_mean", "arithmetic_mean", "quadratic_mean", "squared_average", "total_horizontal_energy", "vector_summation", "maximum_horizontal_value"], "description": "Horizontal combination method."},
            "distribution": {"type": "str", "required": False, "default": "lognormal", "allowed_values": ["lognormal", "normal"], "description": "Statistical distribution."},
