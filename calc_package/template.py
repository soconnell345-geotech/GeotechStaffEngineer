...
<div class="footer">
    ...
    <br>
    <em>This document was generated using artificial intelligence under human guidance.
    Results must be thoroughly reviewed by a licensed professional engineer prior to use.</em>
</div>
