...
\end{center}
\vspace{2pt}
{\footnotesize\noindent\textbf{Basis \& limitations.} This package applies published, industry-standard geotechnical methods (see the References section and each module's design documentation) to the inputs shown above. All quantities are SI. Every method has applicability limits, sign conventions, and edge cases; results are valid only where the selected method and the assumed subsurface and loading conditions apply.}

\vspace{4pt}
{\footnotesize\itshape\noindent This document was generated using artificial intelligence under human guidance and is an analysis aid, not a design deliverable. It creates no engineer-of-record relationship. All inputs, method selections, and results must be independently reviewed by a licensed professional engineer familiar with the site before use. Provided AS IS, without warranty.}
