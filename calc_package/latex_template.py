...
\begin{center}
{\footnotesize Generated by GeotechStaffEngineer --- \VAR{date}}\\[4pt]
{\footnotesize\itshape This document was generated using artificial intelligence under human guidance.\\
Results must be thoroughly reviewed by a licensed professional engineer prior to use.}
\end{center}
